...
<div align="center">
  ...
  <h1 align="center">Forkify Slices</h1>
...
This project require some prequesites and dependenscies to be installed, you can view it online using this [demo](https://fork-ify.netlify.app/). or you can find the instructions below
...
1. Clone the repo
   ```sh
   git clone https://github.com/mghally999/forkify-slices
   ```
